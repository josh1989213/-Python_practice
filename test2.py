...
#double_ma_package
#improt Strategy Decorator
# %%
import numpy as np
#numpy產生的20~300數列,10個一格python習慣忽略最後一個數字
np.arange(20 ,300 ,10)
...
sma_strategy.backtest(df_btc_4h,freq='4h',plot=True)
sma_strategy.backtest(df_btc_4h,variables=variables,freq='4h',plot=True)
# %%
import webbrowser
